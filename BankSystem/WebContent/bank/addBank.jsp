...
<body>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/bank/sendAddBank.do" method="post">
		<h3 class="title1">添加银行</h3>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">银行地址名:</label>
			<div class="col-sm-4">
				<input type="text" name="bankName" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
