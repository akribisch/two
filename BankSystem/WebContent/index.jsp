...
<body class="cbp-spmenu-push">
	...
	<!-- Classie -->
		<script src="${pageContext.request.contextPath }/plugin/js/classie.js"></script>
		<script>
	...
	<!--scrolling js-->
	<script src="${pageContext.request.contextPath }/plugin/js/jquery.nicescroll.js"></script>
