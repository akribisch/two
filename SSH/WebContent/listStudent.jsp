...
<script type="text/javascript">
	...
	function formatSchoolID(value,row,index){
		return row.school.scid;
	};

    function formatSchool(value,row,index){
	        return row.school.scname;
	    };
...
<!-- url:访问后台的路径          toolbar:工具条      pagination：是否允许分页      rownumbers：行的编号 fitColumns：是否填充列    singleSelect：选中行-->
 <table id="dg" title="学生管理" class="easyui-datagrid" 
        ...
        <thead>
            <tr>
                <th field="sid" width="50">学生编号</th>
                <th field="sname" width="50">姓名</th>
                <th width="50" data-options="field:'scid',formatter:formatSchoolID">学校编号</th>
                <th width="50" data-options="field:'scname',formatter:formatSchool">学校</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
        ...
        <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
            ...
            <div style="margin-bottom:10px">
               <input id="cc" class="easyui-combobox" name="schoolId"  label="学校:"
                 data-options="valueField:'scid',textField:'scname',
                 url:'${pageContext.request.contextPath }/querySchool.action'">
            </div>
    ...
    <script type="text/javascript">
        ...
        function editUser(){
            ...
            if (row){//判断是否选中了某一行
                ...
                $('#cc').combobox('select',row.school.scid);//给学校id给默认值
