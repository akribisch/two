...
<body>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/department/addDepartment.do" method="post">
		<h3 class="title1">新增部门</h3>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">部门名称</label>
			<div class="col-sm-4">
				<input type="text" name="depName" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
