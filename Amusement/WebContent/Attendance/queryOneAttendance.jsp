...
<body>
	<form action="${pageContext.request.contextPath }/Attendance/queryAttendance.do?select=one" method="post" class="form-horizontal" role="form" id="myform">
			<table class="table">
				...
				<tr>
					<td>
						<div>
				   			 <div>
				      			<a class="btn btn-default" href="${pageContext.request.contextPath }/Attendance/addAttendance.do" role="button" >上班打卡</a>
				   			 </div>
				 		 </div>
					</td>
					<td>
						<div>
				   			 <div>
				      			<a class="btn btn-default" href="${pageContext.request.contextPath }/Attendance/updateAttendance.do" role="button" >下班打卡</a>
				   			 </div>
				 		 </div>
					</td>
				</tr>
