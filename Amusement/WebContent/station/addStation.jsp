...
<body>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/station/sendAddStation.do" method="post">
		<h3 class="title1">新增岗位</h3>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">岗位名称</label>
			<div class="col-sm-4">
				<input type="text" name="statName" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">岗位人数</label>
			<div class="col-sm-4">
				<input type="text" name="statNum" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">岗位底薪</label>
			<div class="col-sm-4">
				<input type="text" name="money" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
