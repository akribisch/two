...
<body>
	<form action="${pageContext.request.contextPath }/Salary/querySalary.do?select=all" method="post" class="form-horizontal" role="form" id="myform">
			<table class="table">
			...
			<table class="table">
			  ...
			  <thead>
			    <tr>
			      ...
			      <th>日期</th>
			      <th>
			      	<a class="btn btn-default" href="${pageContext.request.contextPath }/Salary/queryAllSalary.do" role="button" >计算本月工资</a>
			      </th>
			    </tr>
			  </thead>
			  <tbody>
