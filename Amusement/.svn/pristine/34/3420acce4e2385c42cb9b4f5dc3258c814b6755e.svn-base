...
<body>
	<form class="form-horizontal" action="${pageContext.request.contextPath }/menu/sendAddMenu.do" method="post">
		<h3 class="title1">新增菜单</h3>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">菜单名称</label>
			<div class="col-sm-4">
				<input type="text" name="menuName" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
			<label for="focusedinput" class="col-sm-2 control-label">菜单地址</label>
			<div class="col-sm-4">
				<input type="text" name="menuUrl" class="form-control1" id="focusedinput">
			</div>
		</div>
		<div class="form-group">
